  ...
  const content = h("div", { class: "page-content" }, [
        ...
        h("div", { class: "button-group" }, [
          h(
            "button",
            {
              ...
              onclick: () => {
                ...
                aboutStore.set((current) => ({ ...current, featureIndex: nextIndex }));
              },
            },
            "Next feature"
          ),
          h(
            "button",
            {
              ...
              onclick: () => {
                aboutStore.set((current) => ({ ...current, featureIndex: 0 }));
              },
            },
            "Reset"
          ),
    ...
    h("div", { class: "card" }, [
      ...
      h(
        "p",
        {},
        "Edit this file (js/views/about.js) while browsing. You'll see the changes without losing the feature counter state."
      ),
      h("p", { class: "info" }, ["💡 Tip: Open the browser console to see HMR logs"]),
    ]),
  ]);
